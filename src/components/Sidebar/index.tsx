...
const Sidebar = () => {
  return (
    <aside className="fixed bottom-2 left-2 right-2 z-10 flex flex-col items-center justify-center rounded bg-base-100/40 p-2 shadow-md backdrop-blur-md md:static md:col-span-1 md:row-start-2 md:row-end-[13] md:justify-start">
      <ul className="grid w-full grid-cols-12 items-center justify-center gap-2 md:flex md:flex-col md:gap-0">
        <li className="col-span-4 md:mb-2 md:w-full">
          <Link
            className="flex w-full justify-center px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal transition md:justify-start"
            href="/dashboard"
          >
            <svg
