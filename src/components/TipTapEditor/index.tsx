...
const MenuBar = ({ editor }: MenuBarProps) => {
  ...
  return (
    <div className="sticky -top-5 z-10 rounded bg-base-900 shadow-md">
      <input
      ...
      <div className="right-0 top-0 grid grid-cols-12 gap-1 rounded-b px-2 pb-2 md:absolute md:pt-2">
        <button className="z-20 col-span-6 rounded border border-accent-200 bg-base-400/20 p-2 text-accent-200 transition hover:bg-base-400/30 active:bg-base-400/40">
          Save Draft
        </button>
        <button className="z-20 col-span-6 rounded bg-accent-200 p-2 text-primary-800 transition hover:bg-accent-300 active:bg-accent-400">
          Publish
        </button>
      </div>
    </div>
...
const TipTapEditor = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="-mt-1 bg-base-100/40 pt-2">
